...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_header.csv'
...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_points.csv'
...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_teams.csv'
...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_box_score.csv'
...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_players.csv'
...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_play_by_play.csv'
...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_comparison.csv'
...
ALTER TABLE euroleague_header DROP COLUMN `team_a`;
ALTER TABLE euroleague_header DROP COLUMN `team_b`;
...
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_play_by_play2.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_points2.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_teams2.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_player_names2.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
FROM euroleague_players
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_players2.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_box_score2.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_comparison2.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_header2.csv'
INTO TABLE euroleague_header
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r'
IGNORE 1 ROWS
...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_play_by_play2.csv'
INTO TABLE euroleague_play_by_play
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r'
IGNORE 1 ROWS
...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_points2.csv'
INTO TABLE euroleague_points
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r'
IGNORE 1 ROWS
...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_player_names2.csv'
INTO TABLE euroleague_player_names
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r'
IGNORE 1 ROWS;

LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_players2.csv'
INTO TABLE euroleague_players
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r'
IGNORE 1 ROWS;

LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_box_score2.csv'
INTO TABLE euroleague_box_score
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r'
IGNORE 1 ROWS
...
LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_comparison2.csv'
INTO TABLE euroleague_comparison
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r'
IGNORE 1 ROWS
...
/* Manually insert team id and general name values into the new "euroleague_team_names" table */

INSERT INTO euro.euroleague_team_names VALUES
('ARI', 'ARIS B.C.'),
('ASV', 'ASVEL BASKET'),
('AVE', 'AIR AVELLINO'),
('BAM', 'BAMBERG BASKETS'),
...
('KSK', 'KARSIYAKA BASKET'),
('LEM', 'LE MANS'),
('LIE', 'RYTAS VILNIUS'),
('LJU', 'KK OLIMPIJA'),
('LMG', 'LIMOGES CSP'),
('MAD', 'REAL MADRID'),
('MAL', 'BALONCESTO MALAGA'),
('MAR', 'MAROUSSI B.C.'),
('MCO', 'AS MONACO'),
('MIL', 'OLIMPIA MILANO'),
...
('ORL', 'ENTENTE ORLEANAISE'),
('PAM', 'VALENCIA BASKET'),
('PAN', 'PANATHINAIKOS B.C.'),
...
('ROM', 'VIRTUS ROMA'),
('SAS', 'DINAMO SASSARI'),
('SIE', 'MONTHEPASCHI SIENA'),
('SOP', 'PROKOM TREFL SOPOT'),
('STR', 'SIG STRASBOURG'),
('TEL', 'MACCABI TEL AVIV'),
('TIV', 'LOKOMOTIV KUBAN'),
('ULK', 'FENERBAHCE'),
('UNK', 'UNICS KAZAN'),
('VIR', 'VIRTUS PALLACANESTRO BOLOGNA'),
('ZAG', 'ZAGREB'),
('ZAL', 'ZALGIRIS KAUNAS'),
('ZGO', 'TUROW ZGORZELEC');

LOAD DATA INFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_teams2.csv'
INTO TABLE euroleague_teams
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r'
IGNORE 1 ROWS;

/* DATA CORRECTION - After creating a new table called euroleague_player_names, modify the previously wrong player_id's. Correct the different typing style of "TOP 16" in header. */
...
SELECT *
FROM euroleague_header
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_header_final.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
SELECT *
FROM euroleague_play_by_play
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_play_by_play_final.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
SELECT *
FROM euroleague_points
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_points_final.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
UNION all
SELECT *
FROM euroleague_team_names
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_team_names_final.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
SELECT *
FROM euroleague_teams
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_teams_final.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_player_names_final.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
SELECT *
FROM euroleague_players
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_players_final.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
SELECT *
FROM euroleague_box_score
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_box_score_final.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
...
SELECT *
FROM euroleague_comparison
INTO OUTFILE 'D:/ProgramData/MySQL/MySQL Server 8.0/Uploads/euroleague_comparison_final.csv'
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r';
